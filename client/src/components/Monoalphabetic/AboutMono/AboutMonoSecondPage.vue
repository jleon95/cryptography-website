...
<template>
  <div id="about-mono-second-page">
    <div class="about-mono-text-blob" id="text-blob-one">
      <p>El <b>tralará por sustitución</b> consiste en cambiar los caracteres dentro del mensaje original por otros distintos.</p>
    </div>
    ...
    <div class="about-mono-text-blob" id="text-blob-three">
      <p>Veamos otro ejemplo. Haz clic en las letras de la primera fila para encriptar el mensaje:</p>
      <EncryptionExample />
    </div>
